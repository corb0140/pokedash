...
export default function PokemonDetailsSideBar() {
  ...
  return (
    <div
      className={`relative h-[81vh] w-full bg-white overflow-y-scroll no-scrollbar rounded-2xl py-6 px-5 shadow-[-2px_0_10px_rgba(0,0,0,0.1)]`}
    >
      {/* IMAGE */}
